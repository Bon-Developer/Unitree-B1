#include "b1_base/legacy_wrapper/robot.hpp"

using namespace qre;

b1_legged_msgs::HighState Robot::extractHighStateMessage() {
    b1_legged_msgs::HighState high_state;
...
b1_legged_msgs::MotorStateArray Robot::extractMotorStateMessage() {
    b1_legged_msgs::MotorStateArray motor_state_array;
...
b1_legged_msgs::LowState Robot::extractLowStateMessage() {
    b1_legged_msgs::LowState low_state;
...
sensor_msgs::BatteryState Robot::extractBatteryStateMessage() {
    ...
    battery_state.location = "left_side_on_body";
    battery_state.serial_number = "B1-223";
