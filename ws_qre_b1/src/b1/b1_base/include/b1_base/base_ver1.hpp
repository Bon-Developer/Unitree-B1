...
// 240723(Park SangTae): mode_subscriber_, body_height_subscriber_, foot_raise_height_subscriber 추가
...
namespace qre{
  ...
  class Base : public Quadruped {
    ...
    ros::Subscriber body_height_subscirber_;
    ros::Subscriber foot_raise_height_subscirber_;
